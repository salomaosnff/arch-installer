<template>
  ...
  >
    ...
    <rect x="313" y="417.90372" width="262" height="16" fill="var(--p-primary-color)" />
    <rect x="313" y="533.90372" width="262" height="16" fill="var(--p-primary-color)" />
    <rect x="313" y="649.90372" width="262" height="16" fill="var(--p-primary-color)" />
    <circle cx="524" cy="388.80743" r="6" fill="var(--p-primary-color)" />
    <circle cx="545" cy="388.80743" r="6" fill="var(--p-primary-color)" />
    <circle cx="566" cy="388.80743" r="6" fill="var(--p-primary-color)" />
    <circle cx="524" cy="502.80743" r="6" fill="var(--p-primary-color)" />
    <circle cx="545" cy="502.80743" r="6" fill="var(--p-primary-color)" />
    <circle cx="566" cy="502.80743" r="6" fill="var(--p-primary-color)" />
    <circle cx="524" cy="616.80743" r="6" fill="var(--p-primary-color)" />
    <circle cx="545" cy="616.80743" r="6" fill="var(--p-primary-color)" />
    <circle cx="566" cy="616.80743" r="6" fill="var(--p-primary-color)" />
    ...
    <rect
      ...
      fill="#e6e6e6"
    />
    <rect x="321.00559" width="245.88383" height="10.44604" fill="var(--p-primary-color)" />
