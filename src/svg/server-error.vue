  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="799.031" height="618.112" viewBox="0 0 799.031 618.112"
    ...
    <g transform="translate(-893 -197)">
      <path
        ...
        transform="translate(1007.711 324.776)" fill="#ccc" />
      ...
      <path d="M352.955,370.945a27.529,27.529,0,0,1-54.321,0H229.146V521.536h193.3V370.945Z"
        transform="translate(966.721 287.378)" fill="#d6d6e3" />
      ...
      <path
        ...
        transform="translate(893 175.089)" fill="#090814" />
      ...
      <g transform="translate(20.477 16.308)">
        <path
          ...
          transform="translate(811.648 85.826)" fill="#F50057" />
      ...
      <path
        ...
        transform="translate(1430.76 546.754)" fill="#fff" />
    </g>
  </svg>
</template>