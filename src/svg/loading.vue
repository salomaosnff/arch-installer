<template>
  ...
  >
    <g transform="translate(-445.17 -153)">
      ...
      <path
        d="M0,1.234H800.292V-1H0Z"
        transform="translate(445.17 831.967)"
        fill="#e6e6e6"
      />
      <path
      ...
      <path
        ...
        transform="translate(600.039 38.118)"
        fill="#090814"
      />
      <path
        d="M369.7,511.912l.752,1.63a3.031,3.031,0,0,0,2.721,1.73h95.3a3.048,3.048,0,0,0,2.746-4.267.906.906,0,0,0-.138-.238Z"
        transform="translate(603.602 38.936)"
        opacity="0.17"
        style="isolation: isolate"
      />
      <path
        d="M216.883,305.2v.012l20.4,83.258h4.6L218.061,288.155Z"
        transform="translate(817.51 158.66)"
        opacity="0.17"
        style="isolation: isolate"
      />
      <path
        ...
        transform="translate(634.145 14.55)"
        fill="#090814"
      />
      <path
        ...
        transform="translate(647.795 14.55)"
        fill="#090814"
        opacity="0.17"
        style="isolation: isolate"
      />
      <path
        d="M260.137,97.7l-19.276,27.513L217.951,299.53l12.421,24.641Z"
        transform="translate(798.101 142.912)"
        fill="var(--p-primary-color)"
      />
    </g>
  </svg>
